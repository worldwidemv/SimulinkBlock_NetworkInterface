...
MAKECMD         = /home/programs/Matlab/matlab16b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = test_NetworkInterface_UDP_Output
MODULES                 = NetworkInterface_01.cpp TCPHandle.cpp UDPHandle.cpp ert_main.cpp test_NetworkInterface_UDP_Output_data.cpp 
MAKEFILE                = test_NetworkInterface_UDP_Output.mk
MATLAB_ROOT             = /home/programs/Matlab/matlab16b
ALT_MATLAB_ROOT         = /home/programs/Matlab/matlab16b
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/examples/test_UDP_ReceiveFromMatlab
S_FUNCTIONS             = rtiostream_utils.c
S_FUNCTIONS_LIB         = /usr/lib/x86_64-linux-gnu/libboost_system.so /usr/lib/x86_64-linux-gnu/libboost_thread.so /usr/lib/x86_64-linux-gnu/libboost_signals.so
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
BUILDARGS               = OPTS="-DON_TARGET_WAIT_FOR_START=0 -DWITH_HW"  OPTIMIZATION_FLAGS=-O3 GENERATE_ASAP2=0 ISPROTECTINGMODEL=NOTPROTECTING SINGLE_LINE_COMMENTS=1
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
MODELLIB                  = test_NetworkInterface_UDP_Outputlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/test_NetworkInterface_UDP_Output_ert_linux \
	-I$(START_DIR) \
	-I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils \
	-I/home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/inc \
	-I/home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/auto_generated \
...
%.o : /home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/auto_generated/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : /home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/src/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : /home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/auto_generated/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : /home/valtin/W_Tools/Stimulator/Github_Repositorys/LIB_NetwokInterface/src/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
