%% Example Script for sending from Matlab and receiving data from Simulink block NetworkInterface
%
%% To run this example:
% 1. open 'test_NetworkInterface_UDP_InputOutput.slx' in Matlab and compile the Simulink diagram
% 2. execute the compiled program -> 'sudo ./test_NetworkInterface_UDP_InputOutput'
% 2a. connect to the program using Simulink and open the 'Scope3' to observe the changes
% 3. run THIS Matlab script (multiple time is also fine)
% 4. stop the program './test_NetworkInterface_UDP_InputOutput' with CONTR-C
%
%% This script will:
% 1. connect to the Simulink block
% 2. receive at least 100 dataset's -> 5 seconds 
% 3. send data every 50ms
